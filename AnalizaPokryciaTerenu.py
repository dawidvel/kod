...
# KONFIGURACJA
# =============================================================================
arcpy.env.workspace = r"E:\lekcje\zimowy_2025_2026\arcpy\ppa_projekt\ppa\ppa.gdb"
output_2014 = "PT_2014"
output_2020 = "PT_2020"
inter = "PT_2014_2020"

# Ścieżki do zapisu wykresów
output_dir = r"E:\lekcje\zimowy_2025_2026\arcpy\ppa_projekt\ppa\Wyniki"
...
# =============================================================================
def create_merged_layer(year, output_name):
    ...
    for fc in arcpy.ListFeatureClasses():
        if year in fc and "OT_PT" in fc:
            inputs.append(fc)

    if not inputs:
        print(f"Nie znaleziono warstw dla roku {year} (szukano: {year})")
        return False
...
if not create_merged_layer("2014", output_2014):
    raise RuntimeError("Nie udało się utworzyć warstwy PT_2014")

if not create_merged_layer("2020", output_2020):
...
if arcpy.Exists(inter):
    ...
    arcpy.analysis.Intersect(
        in_features=[output_2014, output_2020],
...
with arcpy.da.SearchCursor(inter, ["X_KOD", "X_KOD_1", "SHAPE@AREA"]) as cursor:
